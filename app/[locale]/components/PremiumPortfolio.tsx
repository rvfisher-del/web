    ...
    <section id="empresas" className="py-32 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        >
          ...
          <h2 className="text-[clamp(40px,6vw,72px)] font-black leading-[1.1] tracking-tighter text-white mb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
          {companies.map((company, i) => (
            <motion.div
              ...
              className="group relative h-[400px] overflow-hidden border border-white/5 transition-all duration-500 hover:-translate-y-2"
              style={{
              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center p-12 text-center">
                ...
                <div className="mb-8 transition-all duration-500">
                  <img
                    ...
                    style={{
                      filter: hoveredIndex === i ? 'none' : 'grayscale(1) brightness(2)',
