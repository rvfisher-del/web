...
export default function GlassHeader() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-[1200px] z-50 rounded-full border border-white/10 backdrop-blur-2xl transition-all duration-300 ${
        isScrolled 
          ? 'bg-white/10' 
          : 'bg-white/5'
      }`}
      ...
      <div className="px-8 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-10">
          <a
            ...
            className="text-[12px] font-bold tracking-[0.15em] uppercase text-white/80 hover:text-white transition-colors"
          >
